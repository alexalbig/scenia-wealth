...
| AC9 | **La liquidez sale del tipo e ignora el estado del activo** | `AHORA` | Un fondo pignorado sigue marcado como liquidez alta: **el producto conoce el hecho y no lo usa**. No es imprecisión, es una cifra que parece buena sobre un dato que existe. Y no son dos casos sino una familia: un plan de pensiones antes de la contingencia tampoco es accesible, y eso depende de la edad y del año de contingencia. Arreglo: liquidez mostrada = mínimo entre la del tipo y el tope que impone el estado. **El pignorado no es un nivel más bajo, es un estado aparte** —"alta/media/baja" contesta cuánto tarda en ser dinero; pignorado contesta si se puede tocar—: tres niveles como están, más un marcador que los tapa |
| AC10 | **Antes del arreglo: decidir si un activo puede llegar ya pignorado** | `PREGUNTAR` | Hoy pignorar es una decisión de Escenarios, no un atributo del activo. Pero un cliente real puede llegar con un fondo pignorado desde el primer día —**un lombardo es de lo más común en banca privada**—. Si el modelo no tiene ese campo, AC9 no es un arreglo de presentación: **falta el dato**. Preguntar a Dani y a Javi con qué frecuencia ven garantías ya constituidas |
| AC11 | **No distinguir sociedad no cotizada de inmueble dentro de "baja"** | `DESCARTADO` | Es precisión que un semáforo de tres niveles no puede dar sin dejar de ser un semáforo. Y donde esa precisión sí importa —la columna de sostenibilidad— ya se usa una distinción binaria de líquido contra no líquido, que es la correcta para esa pregunta |
